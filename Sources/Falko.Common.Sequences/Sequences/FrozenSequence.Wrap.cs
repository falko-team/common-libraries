...
{
    /// <summary>
    /// Wraps the specified items into a <see cref="Falko.Common.Sequences.FrozenSequence{T}"/>.
    /// </summary>
    /// <param name="items">The items to wrap.</param>
    /// <typeparam name="T">The type of the elements in the sequence.</typeparam>
    /// <returns>A new <see cref="Falko.Common.Sequences.FrozenSequence{T}"/> containing the specified items.</returns>
    ...
    /// <summary>
    /// Wraps the specified item into a <see cref="Falko.Common.Sequences.FrozenSequence{T}"/>.
    /// </summary>
    /// <param name="item">The item to wrap.</param>
    /// <typeparam name="T">The type of the element in the sequence.</typeparam>
    /// <returns>A new <see cref="Falko.Common.Sequences.FrozenSequence{T}"/> containing the specified item.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
