...
{
    /// <summary>
    /// Copy the given <paramref name="enumerable"/> to a new <see cref="Falko.Common.Sequences.FrozenSequence{T}"/>.
    /// </summary>
    /// <param name="enumerable">The enumerable to copy.</param>
    /// <typeparam name="T">The type of the elements in the enumerable.</typeparam>
    /// <returns>A new <see cref="Falko.Common.Sequences.FrozenSequence{T}"/> containing the elements of the given <paramref name="enumerable"/>.</returns>
    ...
    /// <summary>
    /// Copy the given <paramref name="collection"/> to a new <see cref="Falko.Common.Sequences.FrozenSequence{T}"/>.
    /// </summary>
    /// <param name="collection">The collection to copy.</param>
    /// <typeparam name="T">The type of the elements in the collection.</typeparam>
    /// <returns>A new <see cref="Falko.Common.Sequences.FrozenSequence{T}"/> containing the elements of the given <paramref name="collection"/>.</returns>
