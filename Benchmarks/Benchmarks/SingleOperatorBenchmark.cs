...
public class SingleOperatorBenchmark
{
    ...
    public void FrozenSequenceSingle()
    {
        for (var i = 0; i < 3; i++)
        {
            _ = _frozenSequence.Single(static number => number is 50);
        }
    }
    ...
    public void ListSingle()
    {
        for (var i = 0; i < 3; i++)
        {
            _ = _list.Single(static number => number is 50);
        }
    }
}
